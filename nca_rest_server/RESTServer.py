...
from nca.NetworkConfig.NetworkConfigQuery import SanityQuery
from nca.NetworkConfig.ResourcesHandler import ResourcesParser
...
class PolicySetsResource(NCAResource):
    ...
    def post(self):
        ...
        try:
            ...
            peer_container = self.resources_parser.build_peer_container()
            local_res_parser = ResourcesParser()
            local_res_parser.policies_finder.set_peer_container(peer_container)
            local_res_parser.policies_finder.load_policies_from_buffer(entry)
            local_res_parser.policies_finder.parse_policies_in_parse_queue()
